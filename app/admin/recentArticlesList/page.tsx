...
export default function RecentArticlesListPage() {
  const [items, setItems] = useState<RecentArticlesItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const { data } = await axios.delete("/api/RecentArticles", { params: { id } });
  ...
  return (
    <>
      <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16">
        <h1 className="text-2xl font-semibold">RecentArticle's List</h1>
